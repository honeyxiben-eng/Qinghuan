...
interface P extends InputHTMLAttributes<HTMLInputElement>{label?:string;error?:string;w?:number|string;onValidate?:()=>void}
const Input=forwardRef<HTMLInputElement,P>(({label,error,w,className='',onFocus,onBlur,onValidate,...r},ref)=>{
